package edu.pnu.config; // postman : get : localhost:8080/member > 흰 화면에서 개발자도구에서 network에서 header 복사 > 붙여넣기
...
public class SecurityConfig {
	...
	private final OAuth2SuccessHandler successHandler; // 로그인에 성공하면 임의의 사용자를 생성해서 DB에 저장하고 JWT 토큰을 만들어서 응답 헤더에 설정하는 핸들러
